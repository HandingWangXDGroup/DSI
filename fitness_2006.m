function [objF,conG,conV]=fitness_2006(P, problem, aaa)
% objF: the objective function value
% conV: the total number of constraint violation
% conG: the function vlaue of the constraint functions 
popsize = size(P, 1);
...
objF= f; %objective function value 
conG =g; % constraint function value
conV=max(0,g); % constraint violation 
